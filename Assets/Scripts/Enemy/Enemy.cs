...
public class Enemy : MonoBehaviour
{
    ...
    [Header("Specifics")]
    public int goldDrop;
    public bool catKnight;
    public bool computerKnight;
    public bool blueKnight;
    public bool Boss;

    public GameObject blueBuff;
    public GameObject BossBuff;
    ...
    public void TakeTurn()
    {
        ...
        switch (turns[turnNumber].intentType)
        {
            ...
            case EnemyAction.IntentType.AttackDebuff:
                ...
                break;
            default:
                Debug.Log("lmao how did you mess this up");
                break;
        }
    }
